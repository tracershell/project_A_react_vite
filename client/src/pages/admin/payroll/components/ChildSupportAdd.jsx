...
const ChildSupportAdd = ({ uploadedFile, onUpload, onDelete }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.get('/api/admin/payroll/payrolldoc/childsupport/viewpdf', {
        params: form,
        responseType: 'blob',
...
export default ChildSupportAdd;